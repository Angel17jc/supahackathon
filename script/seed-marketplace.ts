...
const shops: ShopSeed[] = [
  {
    ...
    products: [
      ...
      { name: "Aguardiente de Caña", description: "Botella 500 ml, receta tradicional", sku: "FAR-DES-003", category: "Destilados", quantity: 30, costPrice: 3.5, sellingPrice: 6.9, minStock: 10, image: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=600&h=400&fit=crop" },
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Baguette Tradicional", description: "Barra crujiente horneada cada mañana", sku: "ESP-PAN-002", category: "Panes", quantity: 40, costPrice: 0.7, sellingPrice: 1.8, minStock: 15, image: "https://images.unsplash.com/photo-1534620808146-d33bb39128b2?w=600&h=400&fit=crop" },
      ...
      { name: "Croissant de Mantequilla", description: "Hojaldre artesanal, unidad", sku: "ESP-DES-001", category: "Desayuno", quantity: 50, costPrice: 0.6, sellingPrice: 1.6, minStock: 20, image: "https://images.unsplash.com/photo-1530610476181-d83430b64dcd?w=600&h=400&fit=crop" },
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Foco LED 12 W", description: "Luz cálida, rosca E27", sku: "DLU-ELE-001", category: "Electricidad", quantity: 60, costPrice: 1.2, sellingPrice: 3.2, minStock: 20, image: "https://images.unsplash.com/photo-1550985616-10810253b84d?w=600&h=400&fit=crop" },
  ...
  },
  {
    ...
    products: [
      { name: "Banano Orgánico (kg)", description: "Cosecha de la semana", sku: "SOL-FRU-001", category: "Frutas", quantity: 80, costPrice: 0.5, sellingPrice: 1.2, minStock: 25, image: "https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&h=400&fit=crop" },
      ...
      { name: "Lechuga Crespa (unidad)", description: "Fresca, cosechada hoy", sku: "SOL-VER-004", category: "Verduras", quantity: 36, costPrice: 0.4, sellingPrice: 1.1, minStock: 12, image: "https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?w=600&h=400&fit=crop" },
